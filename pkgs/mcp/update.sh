#!/usr/bin/env bash
# Update pkgs/mcp to the latest upstream Git tag.
#
# Usage:
#   pkgs/mcp/update.sh          # auto-detect latest tag
#   pkgs/mcp/update.sh 2.0.0    # pin to a specific version tag
set -euo pipefail
...
SOURCE_URL="https://github.com/modelcontextprotocol/python-sdk/archive/refs/tags/v${VERSION}.tar.gz"
