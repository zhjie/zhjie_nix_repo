#!/usr/bin/env bash
# Update pkgs/pi-acp to the latest version published on npm.
#
# Usage:
#   scripts/update-pi-acp          # auto-detect latest version
#   scripts/update-pi-acp 0.0.28   # pin to a specific version
set -euo pipefail
