#!/usr/bin/env bash
# Update pkgs/docx to the latest version published on npm.
#
# Usage:
#   scripts/update-docx          # auto-detect latest version
#   scripts/update-docx 9.7.1    # pin to a specific version
set -euo pipefail
